...
$(document).ready(function() {
    ...
    $(".toggle-extra-options").click(function() {
        ...
        if ($target.is(':hidden')) {
            ...
            $target.show("slow");
            $(this).html('Add Spouse');
        } else {
            console.log('target visible');
            $target.hide("slow");
            $(this).html('Just Kidding');
        }

        console.log($target.is(':visible'));
    });
    $("#c_zip").mask("99999");
    $("#c_phone").mask("(999) 999-9999");
